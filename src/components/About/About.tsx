...
import ritikImage from "../../assets/pk.png";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            I am Priyanshu Kumar, a Computer Science and Engineering student at
            IIT Jodhpur, passionate about developing innovative software
            solutions. My academic journey, complemented by coursework in Data
            Structures, Machine Learning, and Cyber Security, has equipped me
            with a strong technical foundation. I am proficient in C, C++,
            Python, JavaScript, and SQL, and have hands-on experience with
            modern frameworks like Next.js, React, Node.js, and Express.js. as
            well as databases like SQL and MongoDB.
          </p>
        </ScrollAnimation>
        <ScrollAnimation
